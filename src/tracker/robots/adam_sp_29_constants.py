"""Adam-SP (29-DoF) robot constants and construction helpers.

This variant matches the MJCF used by newer retargeted motion datasets that include
wrist joints (`wristYaw/Pitch/Roll` for L/R).
"""
...
ADAM_SP_29_XML: Path = get_asset_path("adam_sp", "adam_sp_29dof.xml")
...
# Phase 1.5 placeholder wrist parameters (calibrate later).
...
ADAM_SP_29_ARTICULATION = EntityArticulationInfoCfg(
  actuators=(
    ADAM_SP_29_ACT_LEG_PITCH,
    ADAM_SP_29_ACT_LEG_ROLL,
    ADAM_SP_29_ACT_LEG_YAW,
    ADAM_SP_29_ACT_ANKLE_PITCH,
    ADAM_SP_29_ACT_ANKLE_ROLL,
    ADAM_SP_29_ACT_WAIST_ROLL_YAW,
    ADAM_SP_29_ACT_WAIST_PITCH,
    ADAM_SP_29_ACT_SHOULDER,
    ADAM_SP_29_ACT_ELBOW,
    ADAM_SP_29_ACT_WRIST,
  ),
  soft_joint_pos_limit_factor=0.9,
)

ADAM_SP_29_INIT_STATE = EntityCfg.InitialStateCfg(
  pos=(0.0, 0.0, 0.90),
  rot=(0.0, 0.0, 0.0, 1.0),
  lin_vel=(0.0, 0.0, 0.0),
  ang_vel=(0.0, 0.0, 0.0),
...
ADAM_SP_29_KEYFRAMES: dict[str, EntityCfg.InitialStateCfg] = {
  "default": ADAM_SP_29_INIT_STATE
}


def get_assets(meshdir: str) -> dict[str, bytes]:
  assets: dict[str, bytes] = {}
  update_assets(assets, ADAM_SP_29_XML.parent / "meshes", meshdir, recursive=True)
  return assets
...
def get_adam_sp_29_robot_cfg() -> EntityCfg:
  """Return a fresh Adam-SP (29-DoF) robot configuration instance."""
  return EntityCfg(
    init_state=ADAM_SP_29_INIT_STATE,
    collisions=ADAM_SP_29_COLLISIONS,
    spec_fn=get_spec,
    articulation=ADAM_SP_29_ARTICULATION,
  )


ADAM_SP_29_ACTION_SCALE: dict[str, float] = {}
for actuator in ADAM_SP_29_ARTICULATION.actuators:
